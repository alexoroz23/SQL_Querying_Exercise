...
INSERT INTO products (name, price, can_be_returned) VALUES ('grill', 200, true);
...
-- Display only the products that have a price less than 44.00.
 ...
 SELECT products FROM products WHERE price = 44;

-- Display only the products that have a price in between 22.50 and 99.99.

SELECT products FROM products WHERE price BETWEEN 22.50 and 99.99;
